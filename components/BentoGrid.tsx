        ...
        <div className="relative group overflow-hidden rounded-3xl bg-zinc-900/40 border border-white/10 hover:border-violet-500/50 transition-colors duration-500">
          ...
          <div className="p-8 h-full flex flex-col justify-between relative z-10">
            ...
            <div className="space-y-2 mt-4">
              <div className="bg-zinc-800/50 rounded-lg rounded-tl-none p-2 w-3/4 border border-white/5 group-hover:-translate-y-1 transition-transform duration-500">
                <div className="h-1.5 w-1/2 bg-zinc-600 rounded mb-1"></div>
                <div className="h-1.5 w-3/4 bg-zinc-700 rounded"></div>
              </div>
              <div className="bg-violet-500/20 rounded-lg rounded-tr-none p-2 w-3/4 ml-auto border border-violet-500/20 group-hover:-translate-y-2 transition-transform duration-500 delay-75">
        ...
        <div className="relative group overflow-hidden rounded-3xl bg-zinc-900/40 border border-white/10 hover:border-violet-500/50 transition-colors duration-500">
          ...
          <div className="p-8 h-full flex flex-col relative z-10">
            ...
            <div className="mt-auto flex items-center justify-center">
              <div className="w-16 h-8 rounded-full bg-zinc-800 border border-zinc-700 relative p-1 transition-colors group-hover:bg-zinc-700">
                <div className="w-6 h-6 rounded-full bg-white shadow-lg translate-x-0 group-hover:translate-x-8 transition-transform duration-500 ease-in-out"></div>
              </div>
            </div>
          </div>
        </div>
